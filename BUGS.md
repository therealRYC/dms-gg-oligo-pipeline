# Created: 2026-02-20
# Last updated: 2026-02-25 — Add BUG-004/005/006 (cassette splitting, tile 20 oversized, HF set provenance)
...
- **Related work:** OOGGA (Overhang Optimizer for Golden Gate Assembly) provides an alternative DP-based approach to overhang selection that could replace or complement the HF-set-based scoring. Investigation in progress (branch `260225-DP-OOGGA`).
