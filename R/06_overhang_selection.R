...
#'
#' WARNING: The current "potapov_set2_20" set is NOT from Potapov 2018 Table 1.
#' It was generated by greedy individual-fidelity selection (generate_hf_set()),
#' which maximizes per-overhang fidelity but NOT set fidelity. The Potapov paper's
#' Table 1 sets were optimized via simulated annealing for set fidelity and should
#' be used instead. See BUG-006 in BUGS.md.
#'
