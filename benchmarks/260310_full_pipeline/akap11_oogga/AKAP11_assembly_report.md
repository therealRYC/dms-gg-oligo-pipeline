...
| Number of tiles      | 33                                                                             |
| Total variants       | 37170                                                                          |
| Total oligos         | 371700                                                                         |
| Oligo length range   | 134-287 nt                                                                     |
...
**Total oligos:** 371700 | **Length range:** 134-287 nt
...
| Statistic         | Value                              |
| ----------------- | ---------------------------------- |
| Total barcodes    | 371700                             |
| Unique barcodes   | 371700                             |
| GC content range  | 25% - 75%                          |
| GC content mean   | 48.1%                              |
...
| ---------------------- | ------------------------------------------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| oligo_lengths          | All oligos within synthesis length limit                      | PASS   | Range: 134-287 nt (limit: 300)                                                                                                                        |
...
| barcode_uniqueness     | All barcodes are unique                                       | PASS   | 371700 unique / 371700 total                                                                                                                          |
| tile_coverage          | Tiles cover entire gene without gaps                          | PASS   | 5706 / 5706 nt covered                                                                                                                                |
| variant_count          | Expected number of variants generated                         | PASS   | 37170 unique variants (expected: 37170 across 1770/1900 mutable positions; 33630 missense + 1770 nonsense + 1770 wt_control; 130 position(s) skipped) |
| single_codon_change    | Each non-control variant differs by exactly one codon from WT | PASS   | 354000 / 354000 variants confirmed (WT controls excluded)                                                                                             |
| oligo_gc_content       | Oligo GC content within reasonable range (25-75%)             | PASS   | GC range: 30.9-53.6% | 0 oligo(s) with extreme GC                                                                                                     |
...
| reaction_fidelity      | Per-reaction set-level overhang fidelity                      | FAIL   | Min set fidelity: 0.7533 across 66 reactions | 5 reaction(s) below 0.90                                                                               |
| barcode_poliii_term    | No barcodes contain PolIII terminator signal (TTTT)           | PASS   | 0 / 371700 barcode(s) contain TTTT                                                                                                                    |
...
| 2   | 3'WT block        | bsmbi_3wt_tile1_sub1     | 606 nt  | GGAT  | CACA  |
...
```
  [GGAT]----3'WT sub1----[CACA]----3'WT sub2----[TGCC]----3'WT sub3----[TCCG]----3'WT sub4----[AGTG]----3'WT+PolIII sub5----[CACC]
   GGAT                   CACA                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile2_sub1     | 429 nt  | TACA  | CACA  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub2     | 1662 nt | CACA  | TGCC  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 5   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 6   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
...
```
  [TACA]----3'WT sub1----[CACA]----3'WT sub2----[TGCC]----3'WT sub3----[TCCG]----3'WT sub4----[AGTG]----3'WT+PolIII sub5----[CACC]
   TACA                   CACA                   TGCC                   TCCG                   AGTG                          CACC 
```

**Set fidelity:** 0.7533 (6 overhangs)
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile3_sub1     | 249 nt  | TGAG  | CACA  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub2     | 1662 nt | CACA  | TGCC  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 5   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 6   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
...
```
  [TGAG]----3'WT sub1----[CACA]----3'WT sub2----[TGCC]----3'WT sub3----[TCCG]----3'WT sub4----[AGTG]----3'WT+PolIII sub5----[CACC]
   TGAG                   CACA                   TGCC                   TCCG                   AGTG                          CACC 
```

**Set fidelity:** 0.8235 (6 overhangs)
...
### Tile 5 of 33 -- Codons 266-329 (192 nt)
...
| #   | Component       | Part name             | Length | 5' OH | 3' OH |
| --- | --------------- | --------------------- | ------ | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile5_sub1   | 813 nt | ATGG  | ACTT  |
| 2   | Oligo pool      | Tile 5 (12600 oligos) | 248 nt | ACTT  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile5_sub1     | 1470 nt | ACTT  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [ACTT]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   ACTT                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile6_sub1     | 1278 nt | GAAT  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [GAAT]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   GAAT                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| #   | Component       | Part name             | Length | 5' OH | 3' OH |
| --- | --------------- | --------------------- | ------ | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile7_sub2   | 406 nt | CACA  | TCAT  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile7_sub1     | 1122 nt | TCCT  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [TCCT]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   TCCT                   TGCC                   TCCG                   AGTG                          CACC 
```

**Set fidelity:** 0.9658 (5 overhangs)
...
| --- | --------------- | --------------------- | ------ | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile8_sub2   | 562 nt | CACA  | TTAT  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile8_sub1     | 930 nt  | ATCA  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [ATCA]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   ATCA                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| --- | --------------- | --------------------- | ------ | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile9_sub2   | 754 nt | CACA  | AATA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile9_sub1     | 711 nt  | CAAA  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [CAAA]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   CAAA                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| --- | --------------- | ---------------------- | ------ | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile10_sub2   | 973 nt | CACA  | TTAG  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile10_sub1    | 498 nt  | TGAA  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [TGAA]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   TGAA                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| --- | --------------- | ---------------------- | ------- | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile11_sub2   | 1186 nt | CACA  | CTTG  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile11_sub1    | 297 nt  | TAAT  | TGCC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3     | 1518 nt | TGCC  | TCCG  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 5   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |
...
```
  [TAAT]----3'WT sub1----[TGCC]----3'WT sub2----[TCCG]----3'WT sub3----[AGTG]----3'WT+PolIII sub4----[CACC]
   TAAT                   TGCC                   TCCG                   AGTG                          CACC 
```
...
| --- | --------------- | ---------------------- | ------- | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile12_sub2   | 1387 nt | CACA  | TCTA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile12_sub1    | 1635 nt | TACT  | TCCG  |
...
```
  [TACT]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   TACT                   TCCG                   AGTG                          CACC 
```
...
| --- | --------------- | --------------------- | ------- | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile13_sub2  | 1549 nt | CACA  | GGAA  |
...
### Tile 14 of 33 -- Codons 814-882 (207 nt)
...
| --- | --------------- | ---------------------- | ------- | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile14_sub2   | 1666 nt | CACA  | GGTG  |
| 3   | Oligo pool      | Tile 14 (13650 oligos) | 263 nt  | GGTG  | AGAA  |
| 4   | Helper plasmid  | helper_plasmid_insert  | --      | --    | --    |
| 5   | Enzyme + buffer | BsaI-HFv2 + CutSmart   | --      | --    | --    |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile14_sub1    | 1311 nt | TGAA  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TGAA]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   TGAA                   TCCG                   AGTG                          CACC 
```
...
| --- | --------------- | ---------------------- | ------- | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile15_sub3   | 229 nt  | TGCC  | ATAG  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile15_sub1    | 1119 nt | TTCC  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TTCC]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   TTCC                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile16_sub3   | 421 nt  | TGCC  | ATTA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile16_sub1    | 921 nt  | TCAT  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TCAT]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   TCAT                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile17_sub3   | 619 nt  | TGCC  | TCTA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile17_sub1    | 747 nt  | ATCT  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [ATCT]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   ATCT                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile18_sub3  | 793 nt  | TGCC  | ACTT  |
| 4   | Oligo pool      | Tile 18 (8190 oligos) | 185 nt  | ACTT  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[CACA]----5'WT sub2----[TGCC]----5'WT sub3----[ACTT]----oligo+BC----[AGAA]
   ATGG                   CACA                   TGCC                   ACTT                  AGAA 
```
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile18_sub1    | 618 nt  | TATC  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TATC]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   TATC                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile19_sub3  | 922 nt  | TGCC  | GAAT  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile19_sub1    | 507 nt  | ACAA  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [ACAA]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   ACAA                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile20_sub3   | 1033 nt | TGCC  | GAGA  |
| 4   | Oligo pool      | Tile 20 (13230 oligos) | 257 nt  | GAGA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert  | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart   | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[CACA]----5'WT sub2----[TGCC]----5'WT sub3----[GAGA]----oligo+BC----[AGAA]
   ATGG                   CACA                   TGCC                   GAGA                  AGAA 
```
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile20_sub1    | 306 nt  | CAAA  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [CAAA]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   CAAA                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile21_sub3  | 1234 nt | TGCC  | TTAG  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile21_sub1    | 162 nt  | TACA  | TCCG  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4     | 1707 nt | TCCG  | AGTG  |
| 4   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TACA]----3'WT sub1----[TCCG]----3'WT sub2----[AGTG]----3'WT+PolIII sub3----[CACC]
   TACA                   TCCG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile22_sub3  | 1378 nt | TGCC  | GAAG  |
...
### Tile 23 of 33 -- Codons 1314-1362 (147 nt)
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile23_sub3  | 1522 nt | TGCC  | GAAG  |
| 4   | Oligo pool      | Tile 23 (9450 oligos) | 203 nt  | GAAG  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile23_sub1    | 1560 nt | TCAG  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TCAG]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   TCAG                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile24_sub3  | 1669 nt | TGCC  | ATAA  |
| 4   | Oligo pool      | Tile 24 (7980 oligos) | 182 nt  | ATAA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[CACA]----5'WT sub2----[TGCC]----5'WT sub3----[ATAA]----oligo+BC----[AGAA]
   ATGG                   CACA                   TGCC                   ATAA                  AGAA 
```
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile24_sub1    | 1434 nt | GGAA  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [GGAA]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   GGAA                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1   | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile25_sub3  | 1795 nt | TGCC  | ACAA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile25_sub1    | 1335 nt | TGAA  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TGAA]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   TGAA                   AGTG                          CACC 
```
...
| 1   | 5'WT gene block | bsai_5wt_tile7_sub1    | 809 nt  | ATGG  | CACA  |
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3   | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile26_sub4   | 394 nt  | TCCG  | CAAA  |
...
```
  [ATGG]----5'WT sub1----[CACA]----5'WT sub2----[TGCC]----5'WT sub3----[TCCG]----5'WT sub4----[CAAA]----oligo+BC----[AGAA]
   ATGG                   CACA                   TGCC                   TCCG                   CAAA                  AGAA 
```

**Set fidelity:** 0.9800 (6 overhangs)
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile26_sub1    | 1131 nt | TAAG  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [TAAG]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   TAAG                   AGTG                          CACC 
```
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3  | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile27_sub4  | 598 nt  | TCCG  | GAAT  |
| 5   | Oligo pool      | Tile 27 (9240 oligos) | 200 nt  | GAAT  | AGAA  |
| 6   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 7   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[CACA]----5'WT sub2----[TGCC]----5'WT sub3----[TCCG]----5'WT sub4----[GAAT]----oligo+BC----[AGAA]
   ATGG                   CACA                   TGCC                   TCCG                   GAAT                  AGAA 
```
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile27_sub1    | 987 nt  | AGGA  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [AGGA]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   AGGA                   AGTG                          CACC 
```
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3   | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile28_sub4   | 742 nt  | TCCG  | CTAA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile28_sub1    | 768 nt  | ATCT  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [ATCT]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   ATCT                   AGTG                          CACC 
```
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3  | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile29_sub4  | 961 nt  | TCCG  | TATC  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile29_sub1    | 645 nt  | CCTG  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [CCTG]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   CCTG                   AGTG                          CACC 
```
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3   | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile30_sub4   | 1084 nt | TCCG  | AGTA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile30_sub1    | 438 nt  | AAGT  | AGTG  |
| 3   | 3'WT+PolIII block | bsmbi_3wt_tile1_sub5     | 1190 nt | AGTG  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1 | --      | --    | --    |

```
  [AAGT]----3'WT sub1----[AGTG]----3'WT+PolIII sub2----[CACC]
   AAGT                   AGTG                          CACC 
```
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3   | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile31_sub4   | 1291 nt | TCCG  | TCCA  |
| 5   | Oligo pool      | Tile 31 (14910 oligos) | 281 nt  | TCCA  | AGAA  |
| 6   | Helper plasmid  | helper_plasmid_insert  | --      | --    | --    |
| 7   | Enzyme + buffer | BsaI-HFv2 + CutSmart   | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[CACA]----5'WT sub2----[TGCC]----5'WT sub3----[TCCG]----5'WT sub4----[TCCA]----oligo+BC----[AGAA]
   ATGG                   CACA                   TGCC                   TCCG                   TCCA                  AGAA 
```
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2   | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3   | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile32_sub4   | 1516 nt | TCCG  | ATTA  |
...
### Tile 33 of 33 -- Codons 1877-1902 (78 nt)
...
| 2   | 5'WT gene block | bsai_5wt_tile15_sub2  | 1662 nt | CACA  | TGCC  |
| 3   | 5'WT gene block | bsai_5wt_tile26_sub3  | 1518 nt | TGCC  | TCCG  |
| 4   | 5'WT gene block | bsai_5wt_tile33_sub4  | 1711 nt | TCCG  | TACT  |
| 5   | Oligo pool      | Tile 33 (4620 oligos) | 134 nt  | TACT  | AGAA  |
| 6   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 7   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| bsai_5wt_tile14_sub2  | 1666        | BsaI        | 5wt_tile14_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| bsai_5wt_tile23_sub3  | 1522        | BsaI        | 5wt_tile23_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| bsai_5wt_tile33_sub4  | 1711        | BsaI        | 5wt_tile33_sub4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| bsai_5wt_tile4        | 582         | BsaI        | 5wt_tile4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| bsai_5wt_tile5_sub1   | 813         | BsaI        | 5wt_tile5_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
