...
| block_lengths             | All gene blocks within synthesis length limit                 | PASS   | Range: 135-1756 nt (limit: 1800)                                                                                                                      |
...
| block_min_length          | All gene blocks above synthesis minimum length                | FAIL   | 6 block(s) below 300 nt minimum. Range: 135-1756 nt                                                                                                   |
...
| 20   | 4        | 0.9981            | 3         | 1.0000             |
| 21   | 5        | 1.0000            | 3         | 1.0000             |
| 22   | 5        | 0.9439            | 3         | 0.9984             |
...
**Min:** 0.8940 | **Max:** 1.0000 | **Mean:** 0.9969
...
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1248 nt | GTGC  | AAGA  |
...
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1248 nt | GTGC  | AAGA  |
...
| --- | ----------------- | ------------------------ | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)      | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile19_sub1    | 654 nt  | GTGC  | TCAA  |
