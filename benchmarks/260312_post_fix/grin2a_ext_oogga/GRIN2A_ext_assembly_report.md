...
| block_lengths             | All gene blocks within synthesis length limit                 | PASS   | Range: 36-1790 nt (limit: 1800)                                                                                                                      |
...
| oligo_gc_content          | Oligo GC content within reasonable range (25-75%)             | PASS   | GC range: 38.2-67% | 0 oligo(s) with extreme GC                                                                                                      |
...
| block_min_length          | All gene blocks above synthesis minimum length                | FAIL   | 10 block(s) below 300 nt minimum. Range: 36-1790 nt                                                                                                  |
...
| 19   | 4        | 1.0000            | 6         | 0.9333             |
| 20   | 3        | 1.0000            | 5         | 0.9920             |
| 21   | 4        | 1.0000            | 6         | 0.9905             |
| 22   | 5        | 1.0000            | 5         | 0.9904             |
| 23   | 5        | 1.0000            | 4         | 1.0000             |
| 24   | 5        | 0.9599            | 4         | 0.9644             |
| 25   | 5        | 0.9837            | 4         | 1.0000             |
| 26   | 5        | 1.0000            | 4         | 0.9961             |
| 27   | 5        | 1.0000            | 3         | 1.0000             |

**Min:** 0.8940 | **Max:** 1.0000 | **Mean:** 0.9900
...
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1606 nt | AAAT  | AAGA  |
...
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1606 nt | AAAT  | AAGA  |
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile19_sub1     | 375 nt  | AAAT  | TAAA  |
...
```
  [AAAT]----3'WT sub1----[TAAA]----3'WT sub2----[TCAA]----3'WT sub3----[AAAA]----3'WT sub4----[AAGA]----3'WT+PolIII sub5----[CACC]
   AAAT                   TAAA                   TCAA                   AAAA                   AAGA                          CACC 
```

**Set fidelity:** 0.9333 (6 overhangs)
...
| 3   | 3'WT block        | bsmbi_3wt_tile20_sub2     | 36 nt   | AAAA  | CCAA  |
| 4   | 3'WT block        | bsmbi_3wt_tile20_sub3     | 766 nt  | CCAA  | AAGA  |
| 5   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1507 nt | AAGA  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [AGAT]----3'WT sub1----[AAAA]----3'WT sub2----[CCAA]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   AGAT                   AAAA                   CCAA                   AAGA                          CACC 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile25_sub1     | 93 nt   | ATCG  | TTAT  |
| 3   | 3'WT block        | bsmbi_3wt_tile21_sub4     | 511 nt  | TTAT  | AAGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1507 nt | AAGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [ATCG]----3'WT sub1----[TTAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   ATCG                   TTAT                   AAGA                          CACC 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile26_sub1     | 99 nt   | TAAT  | TATC  |
| 3   | 3'WT block        | bsmbi_3wt_tile26_sub2     | 424 nt  | TATC  | AAGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1507 nt | AAGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TAAT]----3'WT sub1----[TATC]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   TAAT                   TATC                   AAGA                          CACC 
```
...
| bsmbi_3wt_tile20_sub2      | 36          | BsmBI       | 3wt_tile20_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| bsmbi_3wt_tile20_sub3      | 766         | BsmBI       | 3wt_tile20_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| bsmbi_3wt_tile21_sub1      | 339         | BsmBI       | 3wt_tile21_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| bsmbi_3wt_tile21_sub3      | 291         | BsmBI       | 3wt_tile21_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| bsmbi_3wt_tile21_sub4      | 511         | BsmBI       | 3wt_tile21_sub4;3wt_tile25_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| bsmbi_3wt_tile25_sub1      | 93          | BsmBI       | 3wt_tile25_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| bsmbi_3wt_tile26_sub1      | 99          | BsmBI       | 3wt_tile26_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| bsmbi_3wt_tile26_sub2      | 424         | BsmBI       | 3wt_tile26_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
