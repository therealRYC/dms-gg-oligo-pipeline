...
| 1    | 1-31      | 567    | 149 nt |
| 2    | 28-83     | 1092   | 224 nt |
| 3    | 80-148    | 1365   | 263 nt |
| 4    | 145-217   | 1449   | 275 nt |
| 5    | 214-283   | 1386   | 266 nt |
| 6    | 280-353   | 1470   | 278 nt |
| 7    | 350-420   | 1407   | 269 nt |
| 8    | 417-468   | 1008   | 212 nt |
| 9    | 465-533   | 1365   | 263 nt |
| 10   | 530-600   | 1407   | 269 nt |
| 11   | 597-672   | 1512   | 284 nt |
| 12   | 669-710   | 798    | 182 nt |
| 13   | 707-770   | 1260   | 248 nt |
| 14   | 767-811   | 861    | 191 nt |
| 15   | 808-883   | 1512   | 284 nt |
| 16   | 880-952   | 1449   | 275 nt |
| 17   | 949-1020  | 1428   | 272 nt |
| 18   | 1017-1081 | 1281   | 251 nt |
| 19   | 1078-1131 | 1050   | 218 nt |
| 20   | 1128-1194 | 1323   | 257 nt |
| 21   | 1191-1255 | 1281   | 251 nt |
| 22   | 1252-1325 | 1470   | 278 nt |
| 23   | 1322-1367 | 882    | 194 nt |
| 24   | 1364-1437 | 1470   | 278 nt |
| 25   | 1434-1465 | 588    | 152 nt |
...
| block_lengths             | All gene blocks within synthesis length limit                 | PASS   | Range: 36-1683 nt (limit: 1800)                                                                                                                     |
...
| oligo_gc_content          | Oligo GC content within reasonable range (25-75%)             | PASS   | GC range: 38.2-68.5% | 0 oligo(s) with extreme GC                                                                                                   |
...
| block_min_length          | All gene blocks above synthesis minimum length                | FAIL   | 9 block(s) below 300 nt minimum. Range: 36-1683 nt                                                                                                  |
| cassette_fragment_lengths | Cassette fragments within synthesis limits                    | PASS   | 2 cassette fragment(s). Range: 332-1584 nt. 0 over max, 0 under min.                                                                                |
...
| 11   | 4        | 1.0000            | 5         | 0.9930             |
| 12   | 4        | 1.0000            | 5         | 1.0000             |
| 13   | 4        | 1.0000            | 4         | 1.0000             |
| 14   | 4        | 1.0000            | 4         | 1.0000             |
| 15   | 4        | 0.8940            | 4         | 1.0000             |
| 16   | 5        | 1.0000            | 4         | 1.0000             |
| 17   | 5        | 0.9986            | 4         | 0.9658             |
| 18   | 5        | 0.9755            | 4         | 1.0000             |
| 19   | 5        | 1.0000            | 4         | 1.0000             |
| 20   | 5        | 1.0000            | 4         | 1.0000             |
| 21   | 5        | 1.0000            | 4         | 1.0000             |
| 22   | 5        | 1.0000            | 5         | 1.0000             |
| 23   | 5        | 0.9472            | 4         | 1.0000             |
| 24   | 6        | 1.0000            | 4         | 0.9961             |
| 25   | 6        | 0.9510            | 3         | 1.0000             |

**Min:** 0.7402 | **Max:** 1.0000 | **Mean:** 0.9843
...
| 2   | Oligo pool      | Tile 1 (567 oligos)                | 149 nt | ATGG  | AGAA  |
...
| 5   | 3'WT block        | bsmbi_3wt_tile1_sub4      | 752 nt  | TTAC  | ACGA  |
| 6   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 7   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TCCC]----3'WT sub1----[AATC]----3'WT sub2----[TCCT]----3'WT sub3----[TTAC]----3'WT sub4----[ACGA]----3'WT+PolIII sub5----[CACC]
   TCCC                   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 2   | Oligo pool      | Tile 2 (1092 oligos)  | 224 nt | GAGA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
```
  [CATC]----3'WT sub1----[AATC]----3'WT sub2----[TCCT]----3'WT sub3----[TTAC]----3'WT sub4----[ACGA]----3'WT+PolIII sub5----[CACC]
   CATC                   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```

**Set fidelity:** 0.7402 (6 overhangs)
...
| 2   | Oligo pool      | Tile 3 (1365 oligos)  | 263 nt | AAGA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
```
  [TGGA]----3'WT sub1----[AATC]----3'WT sub2----[TCCT]----3'WT sub3----[TTAC]----3'WT sub4----[ACGA]----3'WT+PolIII sub5----[CACC]
   TGGA                   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 2   | Oligo pool      | Tile 4 (1449 oligos)  | 275 nt | TTCC  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
```
  [AGTC]----3'WT sub1----[AATC]----3'WT sub2----[TCCT]----3'WT sub3----[TTAC]----3'WT sub4----[ACGA]----3'WT+PolIII sub5----[CACC]
   AGTC                   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```

**Set fidelity:** 0.9194 (6 overhangs)
...
| 2   | Oligo pool      | Tile 5 (1386 oligos)  | 266 nt | AAGA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
```
  [TGAC]----3'WT sub1----[AATC]----3'WT sub2----[TCCT]----3'WT sub3----[TTAC]----3'WT sub4----[ACGA]----3'WT+PolIII sub5----[CACC]
   TGAC                   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```

**Set fidelity:** 0.9777 (6 overhangs)
...
| 2   | Oligo pool      | Tile 6 (1470 oligos)  | 278 nt | TCCT  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
```
  [GGAA]----3'WT sub1----[AATC]----3'WT sub2----[TCCT]----3'WT sub3----[TTAC]----3'WT sub4----[ACGA]----3'WT+PolIII sub5----[CACC]
   GGAA                   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 2   | Oligo pool      | Tile 7 (1407 oligos)  | 269 nt  | TTCA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
**Variants:** 1008 mutations, 1008 oligos
...
| 2   | Oligo pool      | Tile 8 (1008 oligos)  | 212 nt  | GTCA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4      | 752 nt  | TTAC  | ACGA  |
| 5   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TTCC]----3'WT sub1----[TCCT]----3'WT sub2----[TTAC]----3'WT sub3----[ACGA]----3'WT+PolIII sub4----[CACC]
   TTCC                   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 2   | Oligo pool      | Tile 9 (1365 oligos)  | 263 nt  | AAGA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [AATC]----3'WT sub1----[TCCT]----3'WT sub2----[TTAC]----3'WT sub3----[ACGA]----3'WT+PolIII sub4----[CACC]
   AATC                   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 2   | Oligo pool      | Tile 10 (1407 oligos) | 269 nt  | GAAA  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [TACA]----3'WT sub1----[TCCT]----3'WT sub2----[TTAC]----3'WT sub3----[ACGA]----3'WT+PolIII sub4----[CACC]
   TACA                   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 3   | Oligo pool      | Tile 11 (1512 oligos) | 284 nt  | CCTT  | AGAA  |
...
```
  [AAGA]----3'WT sub1----[TCCT]----3'WT sub2----[TTAC]----3'WT sub3----[ACGA]----3'WT+PolIII sub4----[CACC]
   AAGA                   TCCT                   TTAC                   ACGA                          CACC 
```

**Set fidelity:** 0.9930 (5 overhangs)

---

### Tile 12 of 25 -- Codons 669-710 (126 nt)
...
| 3   | Oligo pool      | Tile 12 (798 oligos)  | 182 nt  | AAGT  | AGAA  |
| 4   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 5   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile12_sub1     | 198 nt  | TCAG  | TCCT  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1683 nt | TCCT  | TTAC  |
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub4      | 752 nt  | TTAC  | ACGA  |
| 5   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |
...
```
  [TCAG]----3'WT sub1----[TCCT]----3'WT sub2----[TTAC]----3'WT sub3----[ACGA]----3'WT+PolIII sub4----[CACC]
   TCAG                   TCCT                   TTAC                   ACGA                          CACC 
```
...
### Tile 13 of 25 -- Codons 707-770 (192 nt)
...
| --- | --------------- | --------------------- | ------- | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile11_sub1  | 1613 nt | ATGG  | AATC  |
| 2   | 5'WT gene block | bsai_5wt_tile13_sub2  | 541 nt  | AATC  | AAAT  |
| 3   | Oligo pool      | Tile 13 (1260 oligos) | 248 nt  | AAAT  | AGAA  |
| 4   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 5   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[AATC]----5'WT sub2----[AAAT]----oligo+BC----[AGAA]
   ATGG                   AATC                   AAAT                  AGAA 
```
...
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4      | 752 nt  | TTAC  | ACGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TCCT]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   TCCT                   TTAC                   ACGA                          CACC 
```
...
| 3   | Oligo pool      | Tile 14 (861 oligos)  | 191 nt  | AAAG  | AGAA  |
| 4   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 5   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [CCAG]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   CCAG                   TTAC                   ACGA                          CACC 
```
...
| 3   | Oligo pool      | Tile 15 (1512 oligos) | 284 nt  | ATGA  | AGAA  |
| 4   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 5   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [TCCA]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   TCCA                   TTAC                   ACGA                          CACC 
```
...
| 4   | Oligo pool      | Tile 16 (1449 oligos) | 275 nt  | AAGA  | AGAA  |
...
```
  [GAAA]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   GAAA                   TTAC                   ACGA                          CACC 
```
...
| 4   | Oligo pool      | Tile 17 (1428 oligos) | 272 nt  | TTTC  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [TTCC]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   TTCC                   TTAC                   ACGA                          CACC 
```
...
| 4   | Oligo pool      | Tile 18 (1281 oligos) | 251 nt  | TCCG  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [CAAA]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   CAAA                   TTAC                   ACGA                          CACC 
```
...
| 4   | Oligo pool      | Tile 19 (1050 oligos) | 218 nt  | AAGA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
```
  [AGAT]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   AGAT                   TTAC                   ACGA                          CACC 
```
...
| 4   | Oligo pool      | Tile 20 (1323 oligos) | 257 nt  | TTCC  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
### Tile 21 of 25 -- Codons 1191-1255 (195 nt)
...
| 4   | Oligo pool      | Tile 21 (1281 oligos) | 251 nt  | TTCA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile21_sub1     | 228 nt  | TCAG  | TTAC  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub4      | 752 nt  | TTAC  | ACGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TCAG]----3'WT sub1----[TTAC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   TCAG                   TTAC                   ACGA                          CACC 
```
...
### Tile 22 of 25 -- Codons 1252-1325 (222 nt)
...
| 1   | 5'WT gene block | bsai_5wt_tile11_sub1  | 1613 nt | ATGG  | AATC  |
| 2   | 5'WT gene block | bsai_5wt_tile16_sub2  | 729 nt  | AATC  | TCCT  |
| 3   | 5'WT gene block | bsai_5wt_tile22_sub3  | 1465 nt | TCCT  | CAGA  |
| 4   | Oligo pool      | Tile 22 (1470 oligos) | 278 nt  | CAGA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |

```
  [ATGG]----5'WT sub1----[AATC]----5'WT sub2----[TCCT]----5'WT sub3----[CAGA]----oligo+BC----[AGAA]
   ATGG                   AATC                   TCCT                   CAGA                  AGAA 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile22_sub1     | 378 nt  | TTAC  | TTTA  |
| 3   | 3'WT block        | bsmbi_3wt_tile22_sub2     | 36 nt   | TTTA  | TAGA  |
| 4   | 3'WT block        | bsmbi_3wt_tile22_sub3     | 374 nt  | TAGA  | ACGA  |
| 5   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TTAC]----3'WT sub1----[TTTA]----3'WT sub2----[TAGA]----3'WT sub3----[ACGA]----3'WT+PolIII sub4----[CACC]
   TTAC                   TTTA                   TAGA                   ACGA                          CACC 
```
...
| 4   | Oligo pool      | Tile 23 (882 oligos)  | 194 nt  | GGAA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile23_sub1     | 270 nt  | TTTC  | TAGA  |
| 3   | 3'WT block        | bsmbi_3wt_tile22_sub3     | 374 nt  | TAGA  | ACGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TTTC]----3'WT sub1----[TAGA]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   TTTC                   TAGA                   ACGA                          CACC 
```
...
| 5   | Oligo pool      | Tile 24 (1470 oligos) | 278 nt  | GATA  | AGAA  |
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile24_sub1     | 87 nt   | TAAT  | TATC  |
| 3   | 3'WT block        | bsmbi_3wt_tile24_sub2     | 347 nt  | TATC  | ACGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5 | 1584 nt | ACGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TAAT]----3'WT sub1----[TATC]----3'WT sub2----[ACGA]----3'WT+PolIII sub3----[CACC]
   TAAT                   TATC                   ACGA                          CACC 
```
...
| 5   | Oligo pool      | Tile 25 (588 oligos)  | 152 nt  | AATA  | AGAA  |
| 6   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 7   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |
...
| --- | ----------------- | -------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)        | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_cassette_tile25_sub1 | 332 nt  | TTAA  | ACGA  |
| 3   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub5  | 1584 nt | ACGA  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1   | --      | --    | --    |

```
  [TTAA]----3'WT sub1----[ACGA]----3'WT+PolIII sub2----[CACC]
   TTAA                   ACGA                          CACC 
```
...
| bsai_5wt_tile22_sub3       | 1465        | BsaI        | 5wt_tile22_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| bsmbi_3wt_tile1_sub4       | 752         | BsmBI       | 3wt_tile1_sub4;3wt_tile2_sub4;3wt_tile3_sub4;3wt_tile4_sub4;3wt_tile5_sub4;3wt_tile6_sub4;3wt_tile7_sub4;3wt_tile8_sub3;3wt_tile9_sub3;3wt_tile10_sub3;3wt_tile11_sub3;3wt_tile12_sub3;3wt_tile13_sub2;3wt_tile14_sub2;3wt_tile15_sub2;3wt_tile16_sub2;3wt_tile17_sub2;3wt_tile18_sub2;3wt_tile19_sub2;3wt_tile20_sub2;3wt_tile21_sub2                                                                                                                                                                                                                       |
| bsmbi_3wt_tile10_sub1      | 528         | BsmBI       | 3wt_tile10_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile11_sub1      | 312         | BsmBI       | 3wt_tile11_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile12_sub1      | 198         | BsmBI       | 3wt_tile12_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| bsmbi_3wt_tile21_sub1      | 228         | BsmBI       | 3wt_tile21_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile22_sub1      | 378         | BsmBI       | 3wt_tile22_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile22_sub2      | 36          | BsmBI       | 3wt_tile22_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile22_sub3      | 374         | BsmBI       | 3wt_tile22_sub3;3wt_tile23_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile23_sub1      | 270         | BsmBI       | 3wt_tile23_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile24_sub1      | 87          | BsmBI       | 3wt_tile24_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| bsmbi_3wt_tile24_sub2      | 347         | BsmBI       | 3wt_tile24_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
