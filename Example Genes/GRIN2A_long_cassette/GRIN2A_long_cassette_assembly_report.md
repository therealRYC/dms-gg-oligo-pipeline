...
**Total oligos:** 305970 | **Length range:** 176-294 nt
...
| 22   | 1284-1333 | 9240   | 206 nt |
| 23   | 1328-1402 | 14490  | 281 nt |
| 24   | 1397-1472 | 13650  | 285 nt |
...
| oligo_gc_content          | Oligo GC content within reasonable range (25-75%)             | PASS   | GC range: 43.9-66.3% | 0 oligo(s) with extreme GC                                                                                                   |
...
| barcode_tm_distribution   | Barcode Tm distribution (informational)                       | PASS   | Tm: median=53.3, range=[42, 65.3], sd=4 C                                                                                                           |
| block_min_length          | All gene blocks above synthesis minimum length                | FAIL   | 10 block(s) below 300 nt minimum. Range: 34-1794 nt                                                                                                 |
| cassette_fragment_lengths | Cassette fragments within synthesis limits                    | PASS   | 2 cassette fragment(s). Range: 399-1519 nt. 0 over max, 0 under min.                                                                                |
...
| 19   | 4        | 0.9406            | 6         | 0.9864             |
| 20   | 4        | 0.9406            | 6         | 0.9864             |
| 21   | 5        | 0.9406            | 4         | 1.0000             |
| 22   | 5        | 0.9406            | 5         | 0.9644             |
| 23   | 5        | 0.9406            | 4         | 1.0000             |
| 24   | 5        | 0.9406            | 3         | 1.0000             |

**Min:** 0.9406 | **Max:** 1.0000 | **Mean:** 0.9690
...
| 4   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1294 nt | TAAT  | AAGA  |
| 5   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [CGAC]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   CGAC                   GAAA                   TAAT                   AAGA                          CACC 
```
...
```
  [ACTG]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   ACTG                   GAAA                   TAAT                   AAGA                          CACC 
```
...
```
  [CATT]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   CATT                   GAAA                   TAAT                   AAGA                          CACC 
```
...
### Tile 5 of 24 -- Codons 272-328 (171 nt)
...
| #   | Component       | Part name             | Length | 5' OH | 3' OH |
| --- | --------------- | --------------------- | ------ | ----- | ----- |
| 1   | 5'WT gene block | bsai_5wt_tile5        | 847 nt | TGAA  | TTTC  |
| 2   | Oligo pool      | Tile 5 (10710 oligos) | 227 nt | TTTC  | AGAA  |
| 3   | Helper plasmid  | helper_plasmid_insert | --     | --    | --    |
| 4   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --     | --    | --    |
...
```
  [AGAG]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   AGAG                   GAAA                   TAAT                   AAGA                          CACC 
```
...
```
  [CTGT]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   CTGT                   GAAA                   TAAT                   AAGA                          CACC 
```
...
```
  [ATGC]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   ATGC                   GAAA                   TAAT                   AAGA                          CACC 
```
...
```
  [TGAA]----3'WT sub1----[GAAA]----3'WT sub2----[TAAT]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   TGAA                   GAAA                   TAAT                   AAGA                          CACC 
```
...
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1294 nt | TAAT  | AAGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [CAGA]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   CAGA                   TAAT                   AAGA                          CACC 
```
...
```
  [TGTA]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   TGTA                   TAAT                   AAGA                          CACC 
```
...
```
  [GACA]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   GACA                   TAAT                   AAGA                          CACC 
```
...
```
  [TGAA]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   TGAA                   TAAT                   AAGA                          CACC 
```
...
```
  [GGAC]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   GGAC                   TAAT                   AAGA                          CACC 
```
...
```
  [CTTC]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   CTTC                   TAAT                   AAGA                          CACC 
```
...
```
  [CTTT]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   CTTT                   TAAT                   AAGA                          CACC 
```
...
```
  [TTCC]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   TTCC                   TAAT                   AAGA                          CACC 
```
...
```
  [AGAA]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   AGAA                   TAAT                   AAGA                          CACC 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile18_sub1     | 189 nt  | AGAT  | TAAT  |
| 3   | 3'WT block        | bsmbi_3wt_tile1_sub3      | 1294 nt | TAAT  | AAGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [AGAT]----3'WT sub1----[TAAT]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   AGAT                   TAAT                   AAGA                          CACC 
```
...
| 3   | 3'WT block        | bsmbi_3wt_tile19_sub2     | 216 nt  | TCAA  | AAAA  |
| 4   | 3'WT block        | bsmbi_3wt_tile19_sub3     | 174 nt  | AAAA  | CAAA  |
| 5   | 3'WT block        | bsmbi_3wt_tile19_sub4     | 652 nt  | CAAA  | AAGA  |
| 6   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 7   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [GAAC]----3'WT sub1----[TCAA]----3'WT sub2----[AAAA]----3'WT sub3----[CAAA]----3'WT sub4----[AAGA]----3'WT+PolIII sub5----[CACC]
   GAAC                   TCAA                   AAAA                   CAAA                   AAGA                          CACC 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile20_sub1     | 318 nt  | GAAC  | AAAA  |
| 3   | 3'WT block        | bsmbi_3wt_tile20_sub2     | 34 nt   | AAAA  | CAAA  |
| 4   | 3'WT block        | bsmbi_3wt_tile20_sub3     | 360 nt  | CAAA  | TTTA  |
| 5   | 3'WT block        | bsmbi_3wt_tile20_sub4     | 481 nt  | TTTA  | AAGA  |
| 6   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 7   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [GAAC]----3'WT sub1----[AAAA]----3'WT sub2----[CAAA]----3'WT sub3----[TTTA]----3'WT sub4----[AAGA]----3'WT+PolIII sub5----[CACC]
   GAAC                   AAAA                   CAAA                   TTTA                   AAGA                          CACC 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile21_sub1     | 498 nt  | TCAG  | TTTA  |
| 3   | 3'WT block        | bsmbi_3wt_tile20_sub4     | 481 nt  | TTTA  | AAGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TCAG]----3'WT sub1----[TTTA]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   TCAG                   TTTA                   AAGA                          CACC 
```
...
### Tile 22 of 24 -- Codons 1284-1333 (150 nt)
...
| 1   | 5'WT gene block | bsai_5wt_tile10       | 1792 nt | TGAA  | AACT  |
| 2   | 5'WT gene block | bsai_5wt_tile20_sub2  | 1776 nt | AACT  | CGGA  |
| 3   | 5'WT gene block | bsai_5wt_tile22_sub3  | 375 nt  | CGGA  | CTAA  |
| 4   | Oligo pool      | Tile 22 (9240 oligos) | 206 nt  | CTAA  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart  | --      | --    | --    |

```
  [TGAA]----5'WT sub1----[AACT]----5'WT sub2----[CGGA]----5'WT sub3----[CTAA]----oligo+BC----[AGAA]
   TGAA                   AACT                   CGGA                   CTAA                  AGAA 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile22_sub1     | 366 nt  | CTCA  | TTTA  |
| 3   | 3'WT block        | bsmbi_3wt_tile22_sub2     | 48 nt   | TTTA  | TAGA  |
| 4   | 3'WT block        | bsmbi_3wt_tile22_sub3     | 463 nt  | TAGA  | AAGA  |
| 5   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 6   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [CTCA]----3'WT sub1----[TTTA]----3'WT sub2----[TAGA]----3'WT sub3----[AAGA]----3'WT+PolIII sub4----[CACC]
   CTCA                   TTTA                   TAGA                   AAGA                          CACC 
```
...
### Tile 23 of 24 -- Codons 1328-1402 (225 nt)
...
| 1   | 5'WT gene block | bsai_5wt_tile10        | 1792 nt | TGAA  | AACT  |
| 2   | 5'WT gene block | bsai_5wt_tile20_sub2   | 1776 nt | AACT  | CGGA  |
| 3   | 5'WT gene block | bsai_5wt_tile23_sub3   | 507 nt  | CGGA  | CTGT  |
| 4   | Oligo pool      | Tile 23 (14490 oligos) | 281 nt  | CTGT  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert  | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart   | --      | --    | --    |

```
  [TGAA]----5'WT sub1----[AACT]----5'WT sub2----[CGGA]----5'WT sub3----[CTGT]----oligo+BC----[AGAA]
   TGAA                   AACT                   CGGA                   CTGT                  AGAA 
```
...
| --- | ----------------- | ------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)       | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_3wt_tile23_sub1     | 192 nt  | TCGG  | GAAA  |
| 3   | 3'WT block        | bsmbi_3wt_tile23_sub2     | 448 nt  | GAAA  | AAGA  |
| 4   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4 | 1519 nt | AAGA  | CACC  |
| 5   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1  | --      | --    | --    |

```
  [TCGG]----3'WT sub1----[GAAA]----3'WT sub2----[AAGA]----3'WT+PolIII sub3----[CACC]
   TCGG                   GAAA                   AAGA                          CACC 
```
...
### Tile 24 of 24 -- Codons 1397-1472 (229 nt)
...
| 1   | 5'WT gene block | bsai_5wt_tile10        | 1792 nt | TGAA  | AACT  |
| 2   | 5'WT gene block | bsai_5wt_tile20_sub2   | 1776 nt | AACT  | CGGA  |
| 3   | 5'WT gene block | bsai_5wt_tile24_sub3   | 714 nt  | CGGA  | AATG  |
| 4   | Oligo pool      | Tile 24 (13650 oligos) | 285 nt  | AATG  | AGAA  |
| 5   | Helper plasmid  | helper_plasmid_insert  | --      | --    | --    |
| 6   | Enzyme + buffer | BsaI-HFv2 + CutSmart   | --      | --    | --    |

```
  [TGAA]----5'WT sub1----[AACT]----5'WT sub2----[CGGA]----5'WT sub3----[AATG]----oligo+BC----[AGAA]
   TGAA                   AACT                   CGGA                   AATG                  AGAA 
```
...
| --- | ----------------- | -------------------------- | ------- | ----- | ----- |
| 1   | BsaI product      | (in helper plasmid)        | --      | --    | --    |
| 2   | 3'WT block        | bsmbi_cassette_tile24_sub1 | 399 nt  | TTCA  | AAGA  |
| 3   | 3'WT+PolIII block | bsmbi_cassette_tile1_sub4  | 1519 nt | AAGA  | CACC  |
| 4   | Enzyme + buffer   | BsmBI-v2 + NEBuffer r3.1   | --      | --    | --    |

```
  [TTCA]----3'WT sub1----[AAGA]----3'WT+PolIII sub2----[CACC]
   TTCA                   AAGA                          CACC 
```
...
| bsai_5wt_tile22_sub3       | 375         | BsaI        | 5wt_tile22_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsai_5wt_tile23_sub3       | 507         | BsaI        | 5wt_tile23_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsai_5wt_tile24_sub3       | 714         | BsaI        | 5wt_tile24_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| bsmbi_3wt_tile18_sub1      | 189         | BsmBI       | 3wt_tile18_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile19_sub1      | 360         | BsmBI       | 3wt_tile19_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile19_sub2      | 216         | BsmBI       | 3wt_tile19_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile19_sub3      | 174         | BsmBI       | 3wt_tile19_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile19_sub4      | 652         | BsmBI       | 3wt_tile19_sub4                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile2_sub1       | 1395        | BsmBI       | 3wt_tile2_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| bsmbi_3wt_tile20_sub1      | 318         | BsmBI       | 3wt_tile20_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile20_sub2      | 34          | BsmBI       | 3wt_tile20_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile20_sub3      | 360         | BsmBI       | 3wt_tile20_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile20_sub4      | 481         | BsmBI       | 3wt_tile20_sub4;3wt_tile21_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile21_sub1      | 498         | BsmBI       | 3wt_tile21_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile22_sub1      | 366         | BsmBI       | 3wt_tile22_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile22_sub2      | 48          | BsmBI       | 3wt_tile22_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile22_sub3      | 463         | BsmBI       | 3wt_tile22_sub3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile23_sub1      | 192         | BsmBI       | 3wt_tile23_sub1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| bsmbi_3wt_tile23_sub2      | 448         | BsmBI       | 3wt_tile23_sub2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
